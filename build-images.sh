...
docker build --force-rm=true -f ./Dockerfile.mingw-w64 --build-arg vcpkg_target_triplet=x64-mingw-dynamic --build-arg compiler_target=x86_64-w64-mingw32 --build-arg processor=x86_64 -t abeimler/simple-cppbuilder:x64-mingw-w64 .
docker build --force-rm=true -f ./Dockerfile.mingw-w64 --build-arg vcpkg_target_triplet=x86-mingw-dynamic --build-arg compiler_target=i686-w64-mingw32 --build-arg processor=i686 -t abeimler/simple-cppbuilder:x86-mingw-w64 .
#docker build --force-rm=true -f ./Dockerfile.mingw-w64 --build-arg vcpkg_target_triplet=arm64-mingw-dynamic --build-arg compiler_target=arm64-w64-mingw32 --build-arg processor=arm64 -t abeimler/simple-cppbuilder:arm64-mingw-w64 .
#docker build --force-rm=true -f ./Dockerfile.mingw-w64 --build-arg vcpkg_target_triplet=arm-mingw-dynamic --build-arg compiler_target=arm-w64-mingw32 --build-arg processor=arm -t abeimler/simple-cppbuilder:arm-mingw-w64 .
